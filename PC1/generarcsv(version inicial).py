...
# Basado en estructura común del HTML de Twitter (X)
# Notamos que hay `data-testid="tweet"` en algunos selectores modernos, pero puede variar.
# Vamos a hacer una búsqueda más flexible con heurísticas de usuario, fecha y texto.

# Posibles contenedores de tweets
...
csv_path  # Mostrar ruta del archivo CSV generado
